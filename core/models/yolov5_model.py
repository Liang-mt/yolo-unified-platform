...
Supports both torch.hub and ultralytics backends.
"""
...
class YOLOv5Model(BaseYOLOModel):
    """YOLOv5 model with unified interface."""

    SIZE_MAP = {"n": "yolov5n", "s": "yolov5s", "m": "yolov5m", "l": "yolov5l", "x": "yolov5x"}
    ...
    def _build_model(self):
        ...
        name = self.SIZE_MAP.get(size, f"yolov5{size}")
    ...
    def load_pretrained(self, weights: str) -> "YOLOv5Model":
        from ultralytics import YOLO
