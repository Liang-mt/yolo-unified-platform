...
@MODEL_REGISTRY.register("yolov11")
class YOLOv11Model(BaseYOLOModel):
    """YOLOv11 via ultralytics library."""

    SIZE_MAP = {"n": "yolo11n", "s": "yolo11s", "m": "yolo11m", "l": "yolo11l", "x": "yolo11x"}
